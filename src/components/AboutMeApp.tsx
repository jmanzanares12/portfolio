        ...
        <section className="relative overflow-hidden pt-20 pb-16 px-6">
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center text-center">
                ...
                <div className="max-w-2xl text-muted text-base md:text-lg leading-relaxed font-medium space-y-6 mb-12">
                    <p>
                        Desarrollo soluciones modernas con un enfoque en la escalabilidad, dominando el ecosistema de
                    ...
                    <p className="text-sm border-l-2 border-primary/30 pl-4 italic">
                        Propongo soluciones en ecosistemas ERP
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6">
                    <a
                        href="#projects"
                        className="w-full sm:w-auto px-10 py-4 bg-main-text text-background rounded-2xl font-black uppercase tracking-widest text-[10px] hover:scale-105 active:scale-95 transition-all shadow-xl shadow-primary/5 border border-transparent hover:border-primary/20"
                    >
                        Ver proyectos
                    </a>
